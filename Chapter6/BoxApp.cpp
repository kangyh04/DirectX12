...
void BoxApp::Update(const Timer& gt)
{
	...
	ObjectConstants objConstatns;
	XMStoreFloat4x4(&objConstatns.WorldViewProj, XMMatrixTranspose(worldViewProj));

	mObjectCB->CopyData(0, objConstatns);
}
...
void BoxApp::Draw(const Timer& gt)
{
	...
	auto toPresentBarrier = CD3DX12_RESOURCE_BARRIER::Transition(CurrentBackBuffer(),
