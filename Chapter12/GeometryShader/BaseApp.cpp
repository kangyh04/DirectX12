...
void BaseApp::Draw(const Timer& gt)
{
	...
	mCommandList->SetGraphicsRootConstantBufferView(passCBRootParameterIndex, passCB->GetGPUVirtualAddress() + 1 * passCBByteSize);
...
void BaseApp::UpdateMaterialCBs(const Timer& gt)
{
...
void BaseApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const vector<RenderItem*>& ritems)
{
	...
	for (size_t i = 0; i < ritems.size(); ++i)
	{
		...
		cmdList->SetGraphicsRootConstantBufferView(matCBRootParameterIndex, matCBAddress);
