...
private:
	...
	FrameResource* mCurrFrameResource = NULL;
...
bool LandAndWavesApp::Initialize()
{
	...
	ID3D12CommandList* cmdsLiats[] = { mCommandList.Get() };
	mCommandQueue->ExecuteCommandLists(_countof(cmdsLiats), cmdsLiats);
...
void LandAndWavesApp::BuildRootSignature()
{
	...
	CD3DX12_ROOT_SIGNATURE_DESC rootSigDesc(2, slotRootParameter, 0, NULL, D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT);
...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Shaders\\color.hlsl", NULL, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Shaders\\color.hlsl", NULL, "PS", "ps_5_1");
...
{
	XMFLOAT3 n(
		-0.03f * z * cosf(0.1f * z) - 0.3f * cosf(0.1f * z),
		1.0f,
