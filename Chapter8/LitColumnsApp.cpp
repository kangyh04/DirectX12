...
private:
	...
	virtual void OnMouseDown(WPARAM btnStete, int x, int y) override;
...
void LitColumnsApp::Update(const Timer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void LitColumnsApp::Draw(const Timer& gt)
{
...
void LitColumnsApp::OnKeyboardInput(const Timer& gt)
{

}

void LitColumnsApp::UpdateCamera(const Timer& gt)
{
...
void LitColumnsApp::AnimateMaterials(const Timer& gt)
{

}

void LitColumnsApp::UpdateObjectCBs(const Timer& gt)
{
...
void LitColumnsApp::UpdateMaterialCBs(const Timer& gt)
{
...
void LitColumnsApp::UpdateMainPassCB(const Timer& gt)
{
...
void LitColumnsApp::BuildShaderAndInputLayout()
{
...
void LitColumnsApp::BuildRenderItems()
{
	...
	for (int i = 0; i < 5; ++i)
	{
		...
		leftCylRitem->ObjCBIndex = objCBIndx++;
		...
		rightCylRitem->ObjCBIndex = objCBIndx++;
		...
		leftSphereRitem->ObjCBIndex = objCBIndx++;
		...
		rightSphereRitem->ObjCBIndex = objCBIndx++;
...
void LitColumnsApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const vector<RenderItem*> ritems)
{
